...
const en: Record<string, string> = {
  ...
  "alerts.subtitle": "How OC Infographics is built and operated. All infrastructure runs on Oracle Cloud, made possible by community support.",
  ...
  "alerts.tech.frontend_why": "Static export means the site loads instantly from any CDN or Nginx server with no Node.js process, no cold starts, and no server costs — keeping operations lean and sustainable.",
  ...
  "alerts.tech.infra_why": "The platform leverages Oracle Cloud's generous free tier — 4 OCPUs and 24 GB of RAM across Ampere ARM-based instances — vastly overprovisioned for static file serving. This headroom ensures the platform stays responsive under any realistic traffic load.",
  ...
  "about.cost": "Support Us",
  "about.donate_title": "Help Keep This Running",
  "about.donate.desc": "OC Infographics is independently built and maintained. Your support helps cover infrastructure, domain, and development time — keeping the platform fast, free, and growing. Every contribution, no matter the size, directly sustains this public resource.",
  "about.donate.button": "Support via Buy Me a Coffee",
...
const es: Record<string, string> = {
  ...
  "alerts.subtitle": "Cómo está construido y operado OC Infographics. Toda la infraestructura funciona en Oracle Cloud, posible gracias al apoyo de la comunidad.",
  "alerts.production": "Producción",
  "alerts.production_spec": "Instancia de Oracle Cloud que ejecuta Nginx para servir archivos estáticos y analíticas.",
  ...
  "alerts.tech.frontend_why": "La exportación estática significa que el sitio carga instantáneamente desde cualquier CDN o servidor Nginx sin proceso Node.js, sin arranques en frío y sin costos de servidor — manteniendo la operación eficiente y sostenible.",
  ...
  "alerts.tech.infra": "Toda la plataforma funciona en Oracle Cloud Infrastructure. Una sola instancia de cómputo sirve archivos estáticos a través de Nginx con compresión gzip, cabeceras de caché y refuerzo de seguridad. Cloudflare proporciona DNS y proxy CDN opcional. Let's Encrypt maneja la automatización de certificados SSL mediante certbot.",
  "alerts.tech.infra_why": "La plataforma aprovecha el generoso nivel gratuito de Oracle Cloud — 4 OCPUs y 24 GB de RAM en instancias ARM Ampere — vastamente sobreaprovisionado para servir archivos estáticos. Este margen garantiza que la plataforma se mantenga receptiva bajo cualquier carga de tráfico realista.",
  ...
  "about.purpose.desc": "OC Infographics es un bien público. Creemos que los datos del gobierno — pagados por los contribuyentes — deben ser libremente accesibles, bellamente presentados y genuinamente útiles. No hay anuncios, ni funciones de pago, ni cuentas requeridas. La plataforma se sostiene gracias a la generosidad de la comunidad — si te resulta valiosa, considera apoyar su funcionamiento continuo.",
  ...
  "about.cost": "Apóyanos",
  "about.donate_title": "Ayuda a Mantener Esto Funcionando",
  "about.donate.desc": "OC Infographics se construye y mantiene de forma independiente. Tu apoyo ayuda a cubrir infraestructura, dominio y tiempo de desarrollo — manteniendo la plataforma rápida, gratuita y en crecimiento. Cada contribución, sin importar el tamaño, sostiene directamente este recurso público.",
  "about.donate.button": "Apoyar via Buy Me a Coffee",
  "about.tech": "Cómo Está Construido",
  "about.tech.desc": "Toda la plataforma es un sitio web estático sin servidor backend, sin base de datos y sin llamadas API en tiempo de ejecución. Esto lo mantiene rápido, seguro y eficiente de operar.",
